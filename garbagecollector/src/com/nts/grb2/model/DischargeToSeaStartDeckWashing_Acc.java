...
@Entity
@Table(name = "start_deck_washing_acc_grb2")
@Audited
@EntityListeners(AuditClass.class)
public class DischargeToSeaStartDeckWashing_Acc {
	...
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'start_deck_washing_acc_grb2'")
