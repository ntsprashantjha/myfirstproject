...
@Entity
@Table(name = "discharge_to_ashore_grb2")
@Audited
@EntityListeners(AuditClass.class)
public class DischargeToAshore2 {
	...
	@Column(name = "entry_type", length = 50 , insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'discharge_to_ashore_grb2'")
	...
	public void setEntry_date(java.util.Date date) {
	...
	// ---------different variable from other entry------
