 ...
 */
@WebServlet("/ApprovalEntry_GRB2")
public class ApprovalEntry_GRB2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ApprovalEntry_GRB2() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray return_statment = com.nts.grb2.query.Approve_Entry_GRB2.approveUpdate("discharge_to_ashore_grb2",
				23, 40, "annan",
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("--from grb2 approval entry--");
		...
		try {
			...
			JSONArray return_statment = com.nts.grb2.query.Approve_Entry_GRB2.approveUpdate(jObj.getString("entryType"),
