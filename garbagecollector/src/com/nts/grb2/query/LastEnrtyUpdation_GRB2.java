...
public class LastEnrtyUpdation_GRB2 {
	...
	public int updt(String dt, String time, String timezone, String entrytype, int cond, String dt_only)
			throws SQLException {
		...
		/*
		 * stmt = (Statement) con.createStatement(); String sql =
		 * "insert into master_table(entry_type,entry_date,entry_time,incineration_condition,entry_timeZone) values('"
		 * + entrytype + "','" + dt + "','" + time + "'," + cond + ",'" + timezone +
		 * "')"; System.out.println(sql); int gi=stmt.executeUpdate(sql);
		 */
		PreparedStatement ps = (PreparedStatement) con.prepareStatement(

				"INSERT INTO master_table_grb2 (entry_type,entry_date,entry_time,deck_washing_condition,entry_timezone,entry_date_only) values (?,?,?,?,?,?)",
	...
	public int strt_deck_wash(String dt, String time, String timezone, String entrytype, int cond, String entry_cate,
		...
		PreparedStatement ps = (PreparedStatement) con.prepareStatement(
				"INSERT INTO master_table_grb2 (entry_type,entry_date,entry_time,deck_washing_condition,entry_timezone,deck_washing_entry_category,entry_date_only) values (?,?,?,?,?,?,?)",
				Statement.RETURN_GENERATED_KEYS);
	...
	public int get_crnt_mstr_id() {
		...
		String sql = "SELECT entry_id FROM `master_table_grb2` ORDER BY entry_id DESC LIMIT 1";
	...
	public static void main(String arg[]) throws SQLException {
		System.out.println(new LastEnrtyUpdation_GRB2().get_crnt_mstr_id());
	}
