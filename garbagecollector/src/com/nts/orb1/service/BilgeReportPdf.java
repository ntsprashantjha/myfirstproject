...
public class BilgeReportPdf {
	...
	static final String PDF_FILE_NAME = "orb1_bilge.pdf";
...
//		String dateOfPdf = "";
		...
		JSONArray j1 = BilgeReportData.getReportData("2019-10-01", "2019-10-18");
			...
			for (int i = 1; i <= slot.length() - 1; i++) {
				...
				if (count == 0) {
					...
					try {
						...
						PdfPCell total = new PdfPCell(new Phrase(totalQuan, textfont));
