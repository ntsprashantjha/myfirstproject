...
import com.nts.grb2.service.HeaderFooterForFullBooKEvent_GRB2;
import com.nts.orb1.query.HomeDataFullReportById_orb1;

public class CreateFullPdfBook {
	...
	static final String PDF_FILE_NAME = "orb1_pdfFile.pdf";
	static final JSONObject jsonob = new JSONObject();
	//public static void main(String... args) throws Exception {
	public static JSONArray orb1FileGnrt() throws Exception {
		String[] dateformater = {};
		String dateOfPdf = "";
		...
		HeaderFooterForFullBooKEvent_orb2 event = new HeaderFooterForFullBooKEvent_orb2();
		...
		String all_data_dtls = HomeDataFullReportById_orb1
		...
		for (int i = 0; i <= cnvrtd_dta_dtls.length() - 1; i++) {
			...
			dateformater = jsonObject1.optString("stop_date").split("-");
