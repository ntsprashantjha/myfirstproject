 ...
 */
@WebServlet("/TLD_Inventory_Of_Sludge_Tank_C11_1_C11_2_C11_3")
public class TLD_Inventory_Of_Sludge_Tank_C11_1_C11_2_C11_3 extends HttpServlet {
	 ...
	 */
	public TLD_Inventory_Of_Sludge_Tank_C11_1_C11_2_C11_3() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("**json data from Inventory FrontEnd " + jObj);
					...
					if (checkPreviousDateData.checkDate(stopdate[0])) {
						...
						if (new LastEntryCondCheck().lastEntryCheck(stopdate[0], " ") > 0) {
							...
							if (new LastEntryCondCheck().lastEntryDailyTankSoundsheet(stopdate[0], " ") <= 0) {
								...
								mstrObj.lastEntryUpdation("INVENTORY OF SLUDGE TANK (C 11.1,11.2,11.3)",
										jObj.getString("stop_date"), "", 0, timezone, stopdate[0], 0, 0);

								// Create Audit Of Following Entry In Audit Table
								CreateAudit.auditUpdate(userid, "INVENTORY ENTRY",
										"INVENTORY OF SLUDGE TANK (C 11.1,11.2,11.3)", " ", " ", mac, "ORB1");
