...
import com.nts.orb1.service.SludgeReportData;

/**
 * Servlet implementation class SludgeReport
 */
@WebServlet("/SludgeReport")
public class SludgeReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// JSON Data From FrontEnd
			...
			JSONArray j1;
			try {
				j1 = SludgeReportData.getReportData("2019-10-01", "2019-10-24");
				out.println(j1);
			} catch (Exception e) {
