...
import com.nts.orb1.model.FuelOilBunkeringTankDetailsOrb1;
 ...
 */
@WebServlet("/FuelOilBunkering_H26")
public class FuelOilBunkering_H26 extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(FuelOilBunkering_H26.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FuelOilBunkering_H26() {
		super();
		...
		if (new SoftwareLicenceTime().remainTime() < 0) {
			...
			if (ActiveUserStatus.userstatus(GetUserMacId.getClientMACAddress(request)) == 0) {
				...
				try {
					...
					com.nts.orb1.model.FuelOilBunkeringH26Orb1 obj = new com.nts.orb1.model.FuelOilBunkeringH26Orb1();
					FuelOilBunkeringTankDetailsOrb1 fOil = null;
						...
						if (new LastEntryCondCheck().lastEntryCheck(stopdate[0], " ") > 0) {
							...
							if (new LastEntryCondCheck().lastEntryDailyTankSoundsheet(stopdate[0], " ") <= 0) {
								...
								for (int i = 0; i < jsa.length(); i++) {
									...
									fOil = new FuelOilBunkeringTankDetailsOrb1();
								...
								if (missed) {
									...
									mstrObj.lastEntryUpdation("FUEL OIL BUNKERING (H 26.1,26.2,26.3)",
								...
								CreateAudit.auditUpdate(userid, "Fuel Oil Bunkering",
										"FUEL OIL BUNKERING (H 26.1,26.2,26.3)", " ", " ", mac, "ORB1");
