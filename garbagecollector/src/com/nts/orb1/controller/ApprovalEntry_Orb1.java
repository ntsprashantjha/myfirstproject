 ...
 */
@WebServlet("/ApprovalEntry_Orb1")
public class ApprovalEntry_Orb1 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ApprovalEntry_Orb1() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("--from Orb1 approval entry--");
		...
		try {
			...
			JSONArray return_statment = com.nts.orb1.query.Approve_Entry_ORB1.approveUpdate(jObj.getString("entryType"),
