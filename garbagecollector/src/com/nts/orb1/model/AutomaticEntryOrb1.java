...
@Entity
@Table(name = "automatic_entry")
public class AutomaticEntryOrb1 {
	...
	@Column(name = "destination_tank_id", length = 10)
	private double destination_tank_id;
	...
	public double getDestination_tank_id() {
		return destination_tank_id;
	}

	public void setDestination_tank_id(double destination_tank_id) {
		this.destination_tank_id = destination_tank_id;
	}
	...
	// <----comman and entry variable for every entry------->
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Automatic Entry'")
