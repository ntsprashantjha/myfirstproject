...
@Entity
@Table(name = "failure_oil_filter_equipment_F19_20_21_orb1")
public class FailureOilFltrEquipmentF19_20_21Orb1 {
	...
	@Column(name = "reason_of_failure", length = 20)
	private String reason_of_failure;
	@Column(name = "is_equipment_functional", length = 10)
	private String is_equipment_functional;
	@Column(name = "reason_for_not_operational", length = 20)
	private String reason_for_not_operational;
	@Column(name = "seal_no_for_valve", length = 20)
	private String seal_no_for_valve;
	@Column(name = "valve_no", length = 20)
	private Double valve_no;
	...
	public String getIs_equipment_functional() {
		return is_equipment_functional;
	}

	public void setIs_equipment_functional(String is_equipment_functional) {
		this.is_equipment_functional = is_equipment_functional;
	}

	public String getReason_for_not_operational() {
		return reason_for_not_operational;
	}

	public void setReason_for_not_operational(String reason_for_not_operational) {
		this.reason_for_not_operational = reason_for_not_operational;
	}

	public String getSeal_no_for_valve() {
		return seal_no_for_valve;
	}

	public void setSeal_no_for_valve(String seal_no_for_valve) {
		this.seal_no_for_valve = seal_no_for_valve;
	}

	public Double getValve_no() {
		return valve_no;
	}

	public void setValve_no(Double valve_no) {
		this.valve_no = valve_no;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'FAILURE OF OIL FILTERING EQUIPMENT (F 19,20,21)'")
