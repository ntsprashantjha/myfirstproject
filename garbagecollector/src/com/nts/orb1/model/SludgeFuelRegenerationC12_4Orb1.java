...
@Entity
@Table(name = "sludge_fuel_regeneration_C12_4orb1")
public class SludgeFuelRegenerationC12_4Orb1 {
	//*********FrontEnd Data
	...
	@Column(name = "destination_tank", length = 150)
	private String destination_tank;
	@Column(name = "quan_of_sludge_disposed", length = 10)
	private double quan_of_sludge_disposed;
	@Column(name = "quan_of_blidge_water_generated", length = 10)
	private double quan_of_blidgewater_generated;
	@Column(name = "quantity_retainin_source_tank", length = 10)
	private double quan_ret_sou_tank;
	@Column(name = "quantity_retainin_des_tank", length = 10)
	private double quan_ret_des_tank;
	@Column(name = "destination_fuel_tank", length = 150)
	private String destination_fuel_tank;
	@Column(name = "quantity_fuel_gnerated", length = 10)
	private double quantity_fuel_gnerated;
	...
	public String getDestination_tank() {
		return destination_tank;
	}

	public void setDestination_tank(String destination_tank) {
		this.destination_tank = destination_tank;
	}

	public String getDestination_fuel_tank() {
		return destination_fuel_tank;
	}

	public void setDestination_fuel_tank(String destination_fuel_tank) {
		this.destination_fuel_tank = destination_fuel_tank;
	}

	public double getQuantity_fuel_gnerated() {
		return quantity_fuel_gnerated;
	}

	public void setQuantity_fuel_gnerated(double quantity_fuel_gnerated) {
		this.quantity_fuel_gnerated = quantity_fuel_gnerated;
	}
	...
	public double getQuan_of_sludge_disposed() {
		return quan_of_sludge_disposed;
	}

	public void setQuan_of_sludge_disposed(double quan_of_sludge_disposed) {
		this.quan_of_sludge_disposed = quan_of_sludge_disposed;
	}

	public double getQuan_of_blidgewater_generated() {
		return quan_of_blidgewater_generated;
	}

	public void setQuan_of_blidgewater_generated(double quan_of_blidgewater_generated) {
		this.quan_of_blidgewater_generated = quan_of_blidgewater_generated;
	}

	public double getQuan_ret_des_tank() {
		return quan_ret_des_tank;
	}

	public void setQuan_ret_des_tank(double quan_ret_des_tank) {
		this.quan_ret_des_tank = quan_ret_des_tank;
	}
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Regeneration Of Fuel From Sludge C_12.4'")
