...
@Entity
@Table(name = "sludge_drain_water_frm_sludge_to_blidge_tank")
public class  SludgeDrainWtrFrmSludtoBlidTankC12_2Orb1{
	...
	private String source_sludge_tank;
	@Column(name = "destination_tank", length = 150)
	private String destination_blidge_tank;
	@Column(name = "quantity_transferred", length = 10)
	private double quantity_transferred;
	@Column(name = "quantity_retainin_source_tank", length = 10)
	private double quan_ret_sou_tank;
	@Column(name = "quantity_retainin_destination_tank", length = 10)
	...
	public String getSource_sludge_tank() {
		return source_sludge_tank;
	}

	public void setSource_sludge_tank(String source_sludge_tank) {
		this.source_sludge_tank = source_sludge_tank;
	}

	public String getDestination_blidge_tank() {
		return destination_blidge_tank;
	}

	public void setDestination_blidge_tank(String destination_blidge_tank) {
		this.destination_blidge_tank = destination_blidge_tank;
	}

	public double getQuantity_transferred() {
		return quantity_transferred;
	}

	public void setQuantity_transferred(double quantity_transferred) {
		this.quantity_transferred = quantity_transferred;
	}
	...
	// <----comman and entry variable for every entry------->
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Draining Water From Sludge To Blidge tank'")
