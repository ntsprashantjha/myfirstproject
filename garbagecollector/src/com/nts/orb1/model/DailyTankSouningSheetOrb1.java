...
@Entity
@Table(name = "daily_tank_sounding_sheet_orb1")
public class DailyTankSouningSheetOrb1 {
	...
	@Column(name = "tank_name", length = 150)
	private String tank_name;
	@Column(name = "current_quantity", length = 10)
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Daily Tank Sounding Sheet Updation'")
