...
@Entity
@Table(name = "blidge_er_bwell_to_btank_d13_orb1")
public class BligeERBwellToBtankD13Orb1 {
	...
	public void setStop_date(String stop_date) {
		this.stop_date = stop_date;
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Engine Room Bilge Wells To Bilge Tank D13'")
