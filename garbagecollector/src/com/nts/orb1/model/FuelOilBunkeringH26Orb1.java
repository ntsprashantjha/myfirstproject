...
@Entity
@Table(name = "fuel_oil_bunkerig_h26")
public class FuelOilBunkeringH26Orb1 {

	@Column(name = "entry_code", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'H'")
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'FUEL OIL BUNKERING (H 26.1,26.2,26.3)'")
