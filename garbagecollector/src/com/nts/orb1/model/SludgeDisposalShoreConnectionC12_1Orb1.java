...
@Entity
@Table(name = "sludge_disposal_shoreconnection_C12_1_orb1")
public class SludgeDisposalShoreConnectionC12_1Orb1 {
	...
	public void setFile_size(double file_size) {
		this.file_size = file_size;
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'DisposalOfSludgeViaShoreConnection C 12.1'")
