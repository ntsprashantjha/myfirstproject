...
@Entity
@Table(name="sealing_of_marpol_annex1_related_value")


public class SealingOfMarpolAnnex1RelatedValueOrEquipmentEntity {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(150) default 'Sealing Of Marpol Annex1 Related Value Or Equipment Entity'")
