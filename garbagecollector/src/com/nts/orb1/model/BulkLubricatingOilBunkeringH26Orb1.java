...
@Entity
@Table(name = "bulk_lubricating_oil_bunkerig_h26")
public class BulkLubricatingOilBunkeringH26Orb1 {
	...
	private String port;
	@Column(name = "type_of_oil", length = 50)
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'LUB OIL BUNKERING (H 26.1,26.2,26.4)'")
