...
@Entity
@Table(name = "newly_joined_enginner_Orb1")
public class NewlyJoinedEngineerOrb1 {
	...
	@Column(name = "ows_operation", length = 10)
	...
	@Column(name = "pump_auto_stop", length = 10)
	private boolean pump_auto_stop;
	@Column(name = "incinerator_operation_alarm", length = 10)
	private boolean incinerator_operation_alarm;
	...
	public boolean isOws_operation() {
	...
	public boolean isFifteen_ppm_alarm() {
	...
	public boolean isThree_way_valve_operation() {
	...
	public boolean isPump_auto_stop() {
	...
	public boolean isIncinerator_operation_alarm() {
		return incinerator_operation_alarm;
	}

	public void setIncinerator_operation_alarm(boolean incinerator_operation_alarm) {
		this.incinerator_operation_alarm = incinerator_operation_alarm;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'NEWLY JOINED ENGINEER FAMILIARIZATION(i)'")
