...
@Entity
@Table(name = "blige_transferbw_two_tanks_d13_orb1")
public class BilgeTransferBwTwoTanksD13Orb1 {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Transfer Between Bilge Tanks D13'")
