...
@Entity
@Table(name = "de_bunkering_of_fuel_oil")
public class DeBunkeringOfFuelOil {
	...
	private String port;
	@Column(name = "grade_of_oil", length = 50)
	private String grade_of_oil;
	@Column(name = "percentage_sulphur", length = 10)
	private double percentage_sulphur;
	...
	private String identity_of_sludge_receiver;

	public String getIdentity_of_sludge_receiver() {
		return identity_of_sludge_receiver;
	}

	public void setIdentity_of_sludge_receiver(String identity_of_sludge_receiver) {
		this.identity_of_sludge_receiver = identity_of_sludge_receiver;
	}
	...
	public String getGrade_of_oil() {
		return grade_of_oil;
	}

	public void setGrade_of_oil(String grade_of_oil) {
		this.grade_of_oil = grade_of_oil;
	}

	public double getPercentage_sulphur() {
		return percentage_sulphur;
	}

	public void setPercentage_sulphur(double percentage_sulphur) {
		this.percentage_sulphur = percentage_sulphur;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'de_bunkering_of_fuel_oil'")
