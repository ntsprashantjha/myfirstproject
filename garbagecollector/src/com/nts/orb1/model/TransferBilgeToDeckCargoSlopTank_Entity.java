...
@Entity
@Table(name = "transfer_bilge_to_deckcargo_slop_tank")
public class TransferBilgeToDeckCargoSlopTank_Entity {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Transfer Bildge To Deck Cargo Slop Tank'")
