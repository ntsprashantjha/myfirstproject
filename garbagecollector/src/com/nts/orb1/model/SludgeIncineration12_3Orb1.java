...
@Entity
@Table(name = "sludge_inceration_c12_3orb1")
public class SludgeIncineration12_3Orb1 {
	...
	@Column(name = "quantity_incinerated", length = 10)
	private double quantity_incinerated;
	...
	public double getQuantity_incinerated() {
		return quantity_incinerated;
	}

	public void setQuantity_incinerated(double quantity_incinerated) {
		this.quantity_incinerated = quantity_incinerated;
	}
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Incineration of sludge C 12.3'")
