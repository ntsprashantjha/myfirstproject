...
@Entity
@Table(name = "voluntary_recordings_ows_Orb1")
public class VoluntaryRecordingsOwsOrb1 {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Voluntry Recording-OWS overboard Line Inspection'")
