...
@Entity
@Table(name = "bilge_pumping_overboard_thrw_bwell_ows_D13_orb1")
public class BilgePumpingOverboardThroughOWSBWellD13Orb1 {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(100) default 'Pumping Of Bilge Water Overboard Through OWS From BWell'")
