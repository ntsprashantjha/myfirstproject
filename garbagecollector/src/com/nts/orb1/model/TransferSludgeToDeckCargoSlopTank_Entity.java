...
@Entity
@Table(name = "transfer_sludge_to_deckcargo_slop_tank")
public class TransferSludgeToDeckCargoSlopTank_Entity {
	...
	@Column(name = "deck_slope_tk", length = 255)
	private String deckSlop_tank;
	...
	public String getDeckSlop_tank() {
		return deckSlop_tank;
	}

	public void setDeckSlop_tank(String deckSlop_tank) {
		this.deckSlop_tank = deckSlop_tank;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Transfer Sludge To Deck Cargo Slop Tank'")
