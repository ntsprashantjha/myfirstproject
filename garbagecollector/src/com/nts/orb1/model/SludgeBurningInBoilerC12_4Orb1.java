...
@Entity
@Table(name = "sludge_burning_in_boiler_C12_4")
public class SludgeBurningInBoilerC12_4Orb1 {
	//*********FrontEnd Data
	...
	@Column(name = "quantity_Burned", length = 10)
	private double quantity_burned;
	...
	public double getQuantity_burned() {
		return quantity_burned;
	}

	public void setQuantity_burned(double quantity_burned) {
		this.quantity_burned = quantity_burned;
	}
			...
			private String cmnt;
			@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Sludge Burning In Boiler C_12.4'")
