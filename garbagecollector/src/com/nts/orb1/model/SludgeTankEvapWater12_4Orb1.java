...
@Entity
@Table(name = "sludge_tank_evaporation_of_water_c12_4_orb1")
public class SludgeTankEvapWater12_4Orb1 {
	...
	@Column(name = "quantity_evaporated", length = 10)
	private double quantity_evaporated;
	@Column(name = "quantity_retainin_source_tank", length = 10)
	private double quan_ret_sou_tank;

	public double getQuantity_evaporated() {
		return quantity_evaporated;
	}

	public void setQuantity_evaporated(double quantity_evaporated) {
		this.quantity_evaporated = quantity_evaporated;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Evaportaion of Water From Sludge c12_4_orb1'")
