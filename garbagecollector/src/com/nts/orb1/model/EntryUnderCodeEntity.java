...
@Entity
@Table(name = "entry_under_code")
public class EntryUnderCodeEntity {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'ENTRY UNDER CODE (i)'")
