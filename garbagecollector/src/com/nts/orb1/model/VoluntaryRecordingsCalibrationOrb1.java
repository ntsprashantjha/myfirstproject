...
@Entity
@Table(name = "voluntary_recordings_calibration_Orb1")
public class VoluntaryRecordingsCalibrationOrb1 {
	...
	@Column(name = "findings", length = 50)
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(100) default 'VOLUNTARY RECORDING-CALIBRATION OF 15PPM UNIT'")
