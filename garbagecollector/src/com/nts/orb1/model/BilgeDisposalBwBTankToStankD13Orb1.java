...
@Entity
@Table(name = "blige_disposalbw_btank_to_stank_d13_orb1")
public class BilgeDisposalBwBTankToStankD13Orb1 {
	...
	@Column(name = "qty_retained_src", length = 10)
	private double quan_ret_sou_tank;
	@Column(name = "qty_retained_dest", length = 10)
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'Disposal of Bilge From Bilge Tank to Sludge Tank'")
