...
@Entity
@Table(name = "cargo_hold_btank_to_btank")
public class CargoHoldBTanktoBTankOrb1 {
	...
	@Column(name = "transfer_source", length = 255)
	...
	public void setTransfer_source(String transfer_source) {
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'CARGO HOLD BILGE TANK TO BILGE TANK (i)'")
