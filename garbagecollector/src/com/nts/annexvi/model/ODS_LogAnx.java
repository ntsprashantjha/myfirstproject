...
@Entity
@Table(name = "ods_log_anx")
public class ODS_LogAnx {
	...
	@Column(name = "equipment", length = 30)
	private String equipment;

	@Column(name = "service_done", length = 50)
	private String service_done;

	@Column(name = "amount_of_ods", length = 10)
	private double amount_of_ods;
	...
	public double getAmount_of_ods() {
		return amount_of_ods;
	}

	public void setAmount_of_ods(double amount_of_ods) {
		this.amount_of_ods = amount_of_ods;
	}
	...
	private String cmnt;
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'ODS LOG'")
