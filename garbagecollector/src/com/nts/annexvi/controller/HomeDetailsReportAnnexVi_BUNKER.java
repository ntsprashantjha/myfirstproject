 ...
 */
@WebServlet("/HomeDetailsReportAnnexVi_BUNKER")
public class HomeDetailsReportAnnexVi_BUNKER extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public HomeDetailsReportAnnexVi_BUNKER() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			JSONArray ac = HomeDataFullReportById.entry_id("2019-10-01", strtEndDtCombo[1],
					dbConnection.getConnection(),"BUNKER LOG");
			out.print(ac);
