...
public class HomeDataFullReport1 {
	...
	public JSONArray dtlsViaEntryType(AllFilters allFilters, String forDate) throws Exception {
	...
	public JSONArray allType(AllFilters allFilters, String forDate) throws Exception {
		this.allFilters = allFilters;
		con = dbConnection.getConnection();
	...
	public JSONArray toStatusReAppDate(AllFilters allFilters, String forDate) throws Exception {
		...
		String sqlQuery = "Select * from '" + allFilters.getTablename1() + "' where entry_date between '"
				+ allFilters.getTodate() + "' and '" + allFilters.getFordate() + "'";
		PreparedStatement ps = (PreparedStatement) con.prepareStatement(sqlQuery);
		ResultSet resultSet = ps.executeQuery();
		System.out.println(sqlQuery);
