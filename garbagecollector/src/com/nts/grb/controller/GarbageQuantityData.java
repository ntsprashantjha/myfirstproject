...
/**
 * Servlet implementation class GarbageQuantityData
 */
@WebServlet("/GarbageQuantityData")
public class GarbageQuantityData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			//System.out.println(new GarbageCategoryData().bs("20-07-2019", "01-08-2019"));
			out.print(new GarbageCategoryData().bs("20-07-2019", "01-08-2019"));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.print(new GarbageCategoryData().bs(aa, bb));
		}
