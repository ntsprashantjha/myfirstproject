...
public class CreatePdfDocument {
	...
	//public static void main(String... args) throws Exception {
      public static JSONArray filegnrate(String strtdate, String endDate) throws Exception {
		// create document
		Document document = new Document(PageSize.A4, 36, 36, 68, 36);
		...
		float[] colwidth = { 2.2f, 4.2f, 2f, 1.5f, 1.5f, 3f, 3.5f };
