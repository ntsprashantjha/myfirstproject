...
public class HeaderFooterForFullBooKEvent extends PdfPageEventHelper {
	...
	private void addHeader(PdfWriter writer) throws MalformedURLException, IOException {
		...
		try {
			...
			c4.setColspan(2);
			PdfPCell c5 = new PdfPCell(new Paragraph("Incinerated amount (m3) and remarks"));
...
//			headerTable.setSpacingAfter(500f);
