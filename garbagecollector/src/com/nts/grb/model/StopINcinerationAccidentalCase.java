...
@Entity
@Table(name = "stop_incineration_acc")
@Audited
@EntityListeners(AuditClass.class)
public class StopINcinerationAccidentalCase {
	// <----comman and entry variable for every entry------->
	@Column(name = "entry_type", length = 50, insertable = false, updatable = false, nullable = false, columnDefinition = "varchar(50) default 'stop_incineration_acc'")
